...
class PassageiroVipTestCase extends TestCase{
    ...
    public function run(){
        ...
        $passageiroTeste = new PassageiroVip($validNome, $validSobrenome, $documentoPassageiro, $validNacionalidade, $validCPF,$validDataNascimento, $validEmail, $validPassagens, $pontuacaoVazia, $numero_de_registro, [], $programaDeMilhagem);
        # Add pontos
